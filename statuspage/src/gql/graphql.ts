...
export type CargoFlow = {
  ...
  flowPerMinute?: Maybe<Scalars['Float']['output']>;
...
export type Factory = {
  ...
  mainPowerCircuitId?: Maybe<Scalars['Int']['output']>;
  percentageProducing: Scalars['Int']['output'];
  subPowerCircuitId?: Maybe<Scalars['Int']['output']>;
  type: Scalars['String']['output'];
...
export type SaveDetails = {
  ...
  uploaders?: Maybe<Array<Uploader>>;
};
...
export type SaveDetailsQuery = { __typename?: 'Query', saveDetails?: { __typename?: 'SaveDetails', stations?: Array<{ __typename?: 'Station', cargoTypes?: Array<string> | null, id: string, isUnload: boolean, name: string, shortName: string, type: string, x: number, y: number, cargoFlows?: Array<{ __typename?: 'CargoFlow', type: string, isUnload: boolean, flowPerMinute?: number | null, isExact: boolean }> | null, transporters?: Array<{ __typename?: 'Transporter', id: string, name?: string | null, from: string, to?: string | null, otherStops?: Array<string> | null }> | null }> | null, uploaders?: Array<{ __typename?: 'Uploader', id?: string | null, cargoTypes?: Array<string> | null, x?: number | null, y?: number | null }> | null, factories?: Array<{ __typename?: 'Factory', id: string, type: string, percentageProducing: number, x: number, y: number, mainPowerCircuitId?: number | null, subPowerCircuitId?: number | null }> | null } | null };
